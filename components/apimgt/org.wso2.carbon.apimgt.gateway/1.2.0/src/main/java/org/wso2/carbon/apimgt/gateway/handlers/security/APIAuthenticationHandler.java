...
public class APIAuthenticationHandler extends AbstractHandler implements ManagedLifecycle {
    ...
    public boolean handleResponse(MessageContext messageContext) {
    	...
    	accessControlHeaders = headers.get(APIConstants.CORSHeaders.ACCESS_CONTROL_ALLOW_HEADERS);
    	    	
    	/* Appending access control headers to existing headers came in the response*/
    	if (accessControlHeaders != null && !accessControlHeaders.equals("")) {
    		accessControlHeaders  = accessControlHeaders + "," + APIConstants.CORSHeaders.ACCESS_CONTROL_ALLOW_HEADERS_VALUE;
    	} else {
    		accessControlHeaders = APIConstants.CORSHeaders.ACCESS_CONTROL_ALLOW_HEADERS_VALUE;
    	}
        ...
        headers.put(APIConstants.CORSHeaders.ACCESS_CONTROL_ALLOW_HEADERS, accessControlHeaders);
