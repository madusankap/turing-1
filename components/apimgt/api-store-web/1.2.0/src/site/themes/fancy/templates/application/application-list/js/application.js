function changeAppNameMode(linkObj){
    ...
    $('td:eq(3)',theTr).html('<div class="row-fluid"><div class="span6"> <input class="description-new" maxlength="70" value="'
...
function updateApplication_reset(linkObj){
    ...
    $('td:eq(3)',theTr).html(description);
    //Hide the Save and Cancel buttons
    $("td:eq(4)", theTr).children("div").hide();
    //Show the Edit link
    $("td:eq(4)", theTr).children("a").show();
}
