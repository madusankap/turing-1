...
public final class CFMetaData
{
    ...
    public static CFMetaData fromThrift(org.apache.cassandra.thrift.CfDef cf_def, String resolvedKeyspace) throws InvalidRequestException, ConfigurationException, SyntaxException {
        ColumnFamilyType cfType = ColumnFamilyType.create(cf_def.column_type);
        if (cfType == null)
        {
            throw new InvalidRequestException("Invalid column type " + cf_def.column_type);
