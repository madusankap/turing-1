...
public class ColumnFamilyRowRecordReader extends ColumnFamilyRecordReader {
    ...
    public void initialize(InputSplit split, TaskAttemptContext context) throws IOException {
        ...
        maxRowsFetched = Integer.parseInt(conf.get(HiveConf.ConfVars.HIVE_CASSANDRA_MAX_FETCH_ROW_SIZE.toString()));
    ...
    private class IncrementalStaticRowIterator extends RowIterator {
        ...
        private int maximumRowsLoaded = 20000;
