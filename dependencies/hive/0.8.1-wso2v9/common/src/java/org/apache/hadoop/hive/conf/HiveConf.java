...
public class HiveConf extends Configuration {
  ...
  public static enum ConfVars {
    ...
    HIVE_INSERT_INTO_MULTILEVEL_DIRS("hive.insert.into.multilevel.dirs", false),
      ...
      HIVE_INCREMENTAL_PROCESS_KEYSPACE("hive.incremental.index.cassandra.keyspace", ""),
      ...
      HIVE_CASSANDRA_HADOOP_SPLIT_INDEX_CF_SIZE("cassandra.hadoop.split.index.cf.size", 1),
      HIVE_CASSANDRA_MAX_FETCH_ROW_SIZE("cassandra.rows.fetch.size", 20000),
