...
//    }
    ...
    public long getIndexCFRowKey(long timeStamp, int blockSize) {
    ...
    public Map<ByteBuffer, Map<String, List<Mutation>>> getIndexColumnFamilyMutationMap(Map<String, Long> timeStampMap,
                                                                                        ...
                                                                                        Map<ByteBuffer, Map<String, List<Mutation>>> index_mutation_map,
                                                                                        int blockSize) throws CharacterCodingException {
        ...
        for (String aColumnFamilyName : columnFamilyNames) {
            ...
            String timeStampStr = String.valueOf(getIndexCFRowKey(colTimeStamp, blockSize));
