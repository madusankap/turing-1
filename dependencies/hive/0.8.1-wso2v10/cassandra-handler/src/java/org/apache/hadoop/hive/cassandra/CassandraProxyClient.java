...
public class CassandraProxyClient implements java.lang.reflect.InvocationHandler {
  ...
  private CassandraClientHolder createConnection(String host, String keyspace, Map<String, String> credentials) throws CassandraException {
      ...
      String trustStore = System.getProperty(AbstractColumnSerDe.SSL_TRUSTSTORE, null);
      String trustStorePassword = System.getProperty(AbstractColumnSerDe.SSL_TRUSTSTORE_PASSWORD, null);
      ...
      if (trustStore == null && trustStorePassword == null) {
          ...
          try {
              socket = TSSLTransportFactory.getClientSocket(
                      host, port, AbstractColumnSerDe.SSL_TIME_OUT_VALUE, tsslTransportParameters);
          } catch (TTransportException e) {
              logger.error("Unable to open secure socket to Cassandra server: " + e.getMessage() , e);
