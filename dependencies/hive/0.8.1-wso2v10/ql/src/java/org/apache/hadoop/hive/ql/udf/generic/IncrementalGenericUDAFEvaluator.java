...
//        cassandraDBHandler = new CassandraDBHandler();
    ...
    public ByteBuffer getLastProcessedValue(CassandraDBHandler cassandraDBHandler, String groupByKey, String operationIdentifier) {
    ...
    public void insertProcessedValue(CassandraDBHandler cassandraDBHandler, String groupByKey, String operationIdentifier, PrimitiveObjectInspector.
