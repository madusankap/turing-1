...
public class AMQQueueFactory
{
    ...
    public static synchronized AMQQueue createAMQQueueImpl(String queueName,
                                              boolean durable,
                                              String owner,
                                              boolean autoDelete,
                                              boolean exclusive,
                                              VirtualHost virtualHost, Map<String, Object> arguments) throws AMQSecurityException
    {
        ...
        //do a check to see if the queue already exists. If so return existing
        if(virtualHost.getQueueRegistry().getQueue(queueName) != null) {
            return virtualHost.getQueueRegistry().getQueue(queueName);
        }
