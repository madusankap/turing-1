        ...
        else
        {
            ...
            else
            {
                ...
                if (queue.isDurable())
                {
                    ...
                    try {
                    ClusterResourceHolder.getInstance().getClusterManager().handleQueueRemoval(queue.getName());
                    } catch (CoordinationException e) {
                        throw new AMQException(AMQConstant.INTERNAL_ERROR,"Error during coordination across cluster"+queue.getName());
                    }
                }
