...
public class VirtualHostImpl implements VirtualHost
{
    ...
    private VirtualHostImpl(IApplicationRegistry appRegistry, VirtualHostConfiguration hostConfig, MessageStore store) throws Exception
    {
        ...
        //start subscription coordination
        ...
        //this should happen after message store is initialized
        _VirtualHostConfigSynchronizer.start();

        //create topic delivery worker thread
        boolean isInMemoryMode = ClusterResourceHolder.getInstance().getClusterConfiguration().isInMemoryMode();
        TopicDeliveryWorker topicDeliveryWorker = new TopicDeliveryWorker(this,isInMemoryMode);
