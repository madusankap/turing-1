...
public abstract class ConfigurationPlugin
{
    ...
    protected ArrayList<String> getStringArray(String property) {

        ArrayList<String> serverList = new ArrayList<String>(Arrays.asList(_configuration.getStringArray(property)));
        return serverList;
    }
