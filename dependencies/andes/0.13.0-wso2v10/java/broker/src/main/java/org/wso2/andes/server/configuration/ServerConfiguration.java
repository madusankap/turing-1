...
public class ServerConfiguration extends ConfigurationPlugin implements SignalHandler
{
    ...
    public static final String QPID_HOME = "ANDES_HOME";
    ...
    public int getNumberOfMaximumDeliveryCount() {
        int numberOfMaximumDeliveryCount =  getIntValue("clustering.tuning.maximumNumberOfMessageDeliveryAttempts",1);
    ...
    public String getZookeeperConnection() {
        String connection = "";
        ArrayList<String> zookeeperServerList =  getStringArray("clustering.coordination.ZooKeeperConnection");
        if (zookeeperServerList != null) {
            for (String server : zookeeperServerList) {
    ...
    public int getMaxAckWaitTime() {
        return getIntValue("clustering.tuning.waitTimes.maxAckWaitTime",8640);
    }
    ...
    /* hector client tuning parameters*/
    public int getMaxActive(){
        return getIntValue("hector.maxActive", 4000);
    }

    public long getMaxWaitTimeWhenExhausted (){
        return  getLongValue("hector.maxWaitTimeWhenExhausted", 4000);
    }

    public String getLoadBalancingPolicy(){
        return getStringValue("hector.loadBalancingPolicy", "RoundRobinBalancingPolicy");
    }

    public boolean getUseHostTimeoutTracker(){
        return getBooleanValue("hector.useHostTimeoutTracker", false);
    }

    public int getHostTimeoutCounter(){
        return getIntValue("hector.hostTimeoutCounter",10);
    }

    public int getHostTimeoutSuspensionDurationInSeconds(){
        return getIntValue("hector.hostTimeoutSuspensionDurationInSeconds", 10);
    }
