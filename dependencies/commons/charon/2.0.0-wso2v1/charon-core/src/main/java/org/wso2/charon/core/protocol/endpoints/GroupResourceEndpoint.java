...
/**
 * REST API exposed by Charon-Core to perform operations on UserResource. Any SCIM service provider
 * can call this API perform relevant CRUD operations on USER , based on the HTTP requests received
 * by SCIM Client.
 */
public class GroupResourceEndpoint extends AbstractResourceEndpoint implements ResourceEndpoint {
    ...
    public SCIMResponse get(String id, String format, UserManager userManager) {
        ...
        try {
            ...
            ServerSideValidator.validateRetrievedSCIMObject(group,
    ...
    public SCIMResponse create(String scimObjectString, String inputFormat, String outputFormat,
        ...
        try {
            ...
            ServerSideValidator.validateCreatedSCIMObject(group,
                    SCIMSchemaDefinitions.SCIM_GROUP_SCHEMA);
            ...
            if (createdGroup != null) {
                ...
                httpHeaders.put(
                        ...
                        getResourceEndpointURL(SCIMConstants.GROUP_ENDPOINT) + "/"
                                + createdGroup.getId());
    ...
    public SCIMResponse listByFilter(String filterString, UserManager userManager, String format) {
        ...
        try {
            ...
            if (filterParts == null || filterParts.length != 2) {
                // filter query param is not properly splitted. Hence Throwing unsupported operation
                // exception:400
            ...
            if (userManager != null) {
                ...
                if ((returnedGroups == null) || (returnedGroups.isEmpty())) {
                    String error = "Groups not found in the user store for the filter: "
                            + filterString;
                    // log error.
                    // throw resource not found.
                ...
                Map<String, String> httpHeaders = new HashMap<String, String>();
                httpHeaders.put(SCIMConstants.CONTENT_TYPE_HEADER, format);
                return new SCIMResponse(ResponseCodeConstants.CODE_OK, encodedListedResource,
                        httpHeaders);
    ...
    public ListedResource createListedResource(List<Group> groups) throws CharonException,
            NotFoundException {
