...
/**
 * REST API exposed by Charon-Core to perform bulk operations on UserResource. Any SCIM service
 * provider can call this API perform bulk operations, based on the HTTP requests received by SCIM
 * Client.
 */
