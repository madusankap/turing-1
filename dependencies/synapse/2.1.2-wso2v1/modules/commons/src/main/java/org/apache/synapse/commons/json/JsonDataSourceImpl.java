...
public class JsonDataSourceImpl implements OMDataSource {
    public static final String END_OBJECT = "}";
    public static final String END_ARRAY = "}}";
    public static final String EMPTY_OBJECT = "{}";
    public static final String WRAPPER_OBJECT = "{" + JsonBuilder.K_OBJECT + ":";
    public static final String WRAPPER_ARRAY = "{" + JsonBuilder.K_ARRAY + ":{" + JsonBuilder.K_ARRAY_ELEM + ":";
