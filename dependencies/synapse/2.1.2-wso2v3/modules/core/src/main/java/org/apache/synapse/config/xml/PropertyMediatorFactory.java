...
public class PropertyMediatorFactory extends AbstractMediatorFactory {
    ...
    public Mediator createSpecificMediator(OMElement elem, Properties properties) {
        ...
        if (scope != null) {
            ...
            if (!XMLConfigConstants.SCOPE_AXIS2.equals(valueStr) && !XMLConfigConstants.SCOPE_TRANSPORT.equals(valueStr) &&  !XMLConfigConstants.SCOPE_OPERATION.equals(valueStr)
