    ...
    public void updateSession(MessageContext synCtx, String sessionID) {
        ...
        if (oldSession == null) {
            ...
            if (!sessionID.equals(oldSessionID)) {
                ...
                // following code is commented out in order to fix: https://wso2.org/jira/browse/LB-104
                // No need to explicitly remove session id here, session ids will get cleared once they timed out.
