...
/**
 * ViewSubscriptionsResponse.java
 *
 ...
 */
            ...
            /**
            *  ViewSubscriptionsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubscriptionsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubscriptionsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubscriptionsResponse",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubscriptionsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubscriptionsResponse object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubscriptionsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubscriptionsResponse)org.wso2.carbon.dataservices.core.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
