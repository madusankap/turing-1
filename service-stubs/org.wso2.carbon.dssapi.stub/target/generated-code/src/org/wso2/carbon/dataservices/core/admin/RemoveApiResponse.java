 ...
 */
            ...
            /**
            *  RemoveApiResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveApiResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeApiResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeApiResponse",
    ...
    public static class Factory{
        ...
        */
        public static RemoveApiResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveApiResponse object =
                new RemoveApiResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeApiResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveApiResponse)org.wso2.carbon.dataservices.core.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
