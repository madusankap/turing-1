...
/**
 * GetDataServiceContentAsString.java
 *
 ...
 */
            ...
            /**
            *  GetDataServiceContentAsString bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDataServiceContentAsString
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDataServiceContentAsString",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDataServiceContentAsString",
    ...
    public static class Factory{
        ...
        */
        public static GetDataServiceContentAsString parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDataServiceContentAsString object =
                new GetDataServiceContentAsString();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDataServiceContentAsString".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDataServiceContentAsString)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://admin.core.dataservices.carbon.wso2.org","serviceId").equals(reader.getName())){
