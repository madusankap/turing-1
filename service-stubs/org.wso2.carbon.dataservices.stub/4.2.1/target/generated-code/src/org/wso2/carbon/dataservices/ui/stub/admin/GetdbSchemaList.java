 ...
 */
            ...
            /**
            *  GetdbSchemaList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetdbSchemaList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getdbSchemaList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getdbSchemaList",
    ...
    public static class Factory{
        ...
        */
        public static GetdbSchemaList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetdbSchemaList object =
                new GetdbSchemaList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getdbSchemaList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetdbSchemaList)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
