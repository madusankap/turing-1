 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static GetTableList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTableList object =
                new GetTableList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTableList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTableList)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
