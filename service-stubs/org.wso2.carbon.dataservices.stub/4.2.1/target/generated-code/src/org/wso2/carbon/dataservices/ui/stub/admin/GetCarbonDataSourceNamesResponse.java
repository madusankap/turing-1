...
/**
 * GetCarbonDataSourceNamesResponse.java
 *
 ...
 */
            ...
            /**
            *  GetCarbonDataSourceNamesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCarbonDataSourceNamesResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://admin.core.dataservices.carbon.wso2.org",
                "getCarbonDataSourceNamesResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getCarbonDataSourceNamesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getCarbonDataSourceNamesResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetCarbonDataSourceNamesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCarbonDataSourceNamesResponse object =
                new GetCarbonDataSourceNamesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getCarbonDataSourceNamesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCarbonDataSourceNamesResponse)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
