 ...
 */
            ...
            /**
            *  GetPaginatedTableInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPaginatedTableInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPaginatedTableInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPaginatedTableInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetPaginatedTableInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPaginatedTableInfo object =
                new GetPaginatedTableInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPaginatedTableInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPaginatedTableInfo)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
