...
/**
 * GetCarbonDataSourceNamesForTypes.java
 *
 ...
 */
            ...
            /**
            *  GetCarbonDataSourceNamesForTypes bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCarbonDataSourceNamesForTypes
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getCarbonDataSourceNamesForTypes",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getCarbonDataSourceNamesForTypes",
                ...
                if (localTypesTracker){
                             if (localTypes!=null) {
                                   ...
                                   for (int i = 0;i < localTypes.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://admin.core.dataservices.carbon.wso2.org", "types", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static GetCarbonDataSourceNamesForTypes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCarbonDataSourceNamesForTypes object =
                new GetCarbonDataSourceNamesForTypes();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getCarbonDataSourceNamesForTypes".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCarbonDataSourceNamesForTypes)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://admin.core.dataservices.carbon.wso2.org","types").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://admin.core.dataservices.carbon.wso2.org","types").equals(reader.getName())){
