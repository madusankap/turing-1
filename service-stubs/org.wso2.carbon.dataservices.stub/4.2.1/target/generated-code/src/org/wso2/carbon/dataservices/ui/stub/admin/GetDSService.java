 ...
 */
            ...
            /**
            *  GetDSService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDSService
    ...
    public static class Factory{
        ...
        */
        public static GetDSService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDSService object =
                new GetDSService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDSService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDSService)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
