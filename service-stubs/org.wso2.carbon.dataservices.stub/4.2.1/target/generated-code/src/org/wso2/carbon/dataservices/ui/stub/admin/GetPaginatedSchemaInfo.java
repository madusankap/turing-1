 ...
 */
            ...
            /**
            *  GetPaginatedSchemaInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPaginatedSchemaInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPaginatedSchemaInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPaginatedSchemaInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetPaginatedSchemaInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPaginatedSchemaInfo object =
                new GetPaginatedSchemaInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPaginatedSchemaInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPaginatedSchemaInfo)org.wso2.carbon.dataservices.ui.stub.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
